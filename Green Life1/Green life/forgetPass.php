...
$transport = (new Swift_SmtpTransport('smtp.gmail.com', 465,'ssl'))
    ->setUsername('greenlife2482000@gmail.com')
    ->setPassword('123@Green')
;
...
function sendPassword($userEmail,$token){
    global $mailer;
    $body='<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div> 
    <p>
    click into link to rest password
</p>
<a href="http://localhost/Green%20Life/index.php?token='. $token .'"></a>
    </div>
</body>';
    // Create a message
    $message = (new Swift_Message('Reset your password'))
        ->setFrom(['greenlife2482000@gmail.com'])
        ->setTo([$userEmail])
