...
<div class="navbar">
    ...
    <a class="link-1" href="offer.php" style="width:10% ;font-size: 15px;"><b>MENU</b></a>
...
<form class="form-horizontal" method="get" >
    <fieldset>
        ...
        <!-- Form Name -->
        <h1 style="text-align: center">Offer you want to add</h1>
        ...
        <!-- Text input previous price-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="product_previous_price"  style="font-family: '."EB Garamond".', serif ">PREVIOUS PRICE</label>
            <div class="col-md-4">
                <input id="product_previous_price" name="product_previous_price" placeholder="PREVIOUS PRICE" class="form-control input-md" required="" type="text">

            </div>
        </div>
        <!-- Text input new price-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="product_new_price"  style="font-family: '."EB Garamond".', serif ">NEW PRICE</label>
            <div class="col-md-4">
                <input id="product_new_price" name="product_new_price" placeholder="NEW PRICE" class="form-control input-md" required="" type="text">
...
if(isset($_GET['za'])) {
    ...
    $previous_price = $_GET['product_previous_price'];
    $new_price = $_GET['product_new_price'];
    $im="'".$_GET['submit']."'";
    $table='`offer`';
    $flag=true;
    if($im==''){
    ...
    $db->query("UPDATE ".$table." SET `name`=".$name.",`description`=".$description.",`previous_price`=".$previous_price.",`new_price`=".$new_price.",`image`=".$im." WHERE `id`=".$id);
    $flag = false;
    ?>
    ...
    if($flag){
        ...
        $insert=  $db->query("INSERT INTO `offer` (`id`, `name`,`description` ,`previous_price`,`new_price`, `image`) VALUES ($id,$name,$description,$previous_price,$new_price,$im)");
        ?>
