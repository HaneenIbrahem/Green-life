...
<h1 class="headd" style="text-align:  center">Chicken</h1>
...
<div class="col-md-12">
    <div class="row">
        ...
        while ($row=mysqli_fetch_array($result)){
            ...
            <form method="post" action="chicken.php?action=add&id= '.$row["id"].'">
                <div class="container">
                    ...
                    <div class="middle">
                        ...
                        <div class="aa5" id="z'.$count.'"><b>'.$p.'$</b></div> <!--السعر-->
                        
                        <div class="aa6">How much do you want from this?</div>
                        <br>
    ...
    border-color: #27ae60;">
        ...
        for($x=1;$x<=20;$x++)
            if (isset($_POST['add_to_cart' . $x])) {
                ...
                $d =" SELECT `id`, `name`,`description`, `price`, `image` FROM `chicken` WHERE `id`=".$x;
                $result=$db->query($d);
