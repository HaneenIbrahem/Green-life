...
<h1 class="headd" style="text-align:  center">Soup</h1>
...
<div class="col-md-12">
    <div class="row">
        ...
        while ($row=mysqli_fetch_array($result)){
            ...
            <form method="post" action="soup.php?action=add&id= '.$row["id"].'">
                <div class="container">
    ...
    border-color: #27ae60;">
        ...
        for($x=1;$x<=15;$x++)
            if (isset($_POST['add_to_cart' . $x])) {
                ...
                $d =" SELECT `id`, `name`, `description`,`price`, `image` FROM `soup` WHERE `id`=".$x;
                $result=$db->query($d);
